    ...
    <div className="bb-glass rounded-2xl p-6">
      ...
      {items.length === 0 ? (
        <div className="mt-6 flex flex-col items-center py-6 text-center">
          <Activity size={32} className="text-ink-faint" />
          <p className="mt-3 text-sm text-ink-faint">No recent activity yet</p>
        ...
        <div className="relative mt-6 space-y-0">
          <div className="absolute bottom-2 left-[7px] top-2 w-px bg-[var(--surface-strong)]" />
          {items.map((item, i) => (
