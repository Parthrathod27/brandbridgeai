      ...
      <div className="bb-glass-strong relative z-10 flex max-h-[90vh] w-full flex-col overflow-hidden rounded-t-3xl sm:max-w-xl sm:rounded-3xl">
        ...
        {loading ? (
          <div className="flex flex-col items-center py-16">
            ...
            <p className="mt-3 text-sm text-white/50">Generating AI proposal with Gemini...</p>
          </div>
        ) : (
          <>
            <div className="flex gap-2 border-b border-white/10 px-6 pt-3">
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4">
              {tab === "proposal" ? (
                ...
                <pre className="whitespace-pre-wrap text-sm text-white/70">{emailDraft}</pre>
              )}
            </div>
