  ...
  return (
    <div className="flex h-[calc(100vh-80px)] overflow-hidden bg-bg text-ink">
        ...
        {activeConversation ? (
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center p-8">
            ...
            <button
              ...
              className="px-6 py-2 bg-purple hover:bg-purple text-ink rounded-full font-medium transition-colors"
            >
      ...
      {activeConversation && isContextPanelOpen && (
        <div className="w-80 border-l border-[var(--border)] hidden lg:flex flex-col bg-surface">
          <ContextPanel
            conversation={activeConversation}
            role={role}
